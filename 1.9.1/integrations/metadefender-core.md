...
[MetaDefender Core](https://docs.opswat.com/mdcore/release-notes) now fully integrates with OPSWAT Filescan Sandbox (as an engine module), and provide two separate engines:
