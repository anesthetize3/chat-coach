...
Search for reports. Finds reports and uploaded files by various tokens. It uses [OPSWAT Filescan API Reference v1](/1.9.1/opswat-filescan/ref#search-report-api-reports-search-get) endpoint and the 'query' field.
...
Get the reputation for one given hash (returns with the last 10 Filescan reports). It uses [GET - Get Reputation](/1.9.1/opswat-filescan/ref#get-reputation-api-reputation-get) endpoint.
