...
Scan URL resource with Filescan [POST - Scan URL](/1.9.1/opswat-filescan/ref#scan-file-api-scan-url-post)
...
Scan file resource with Filescan [POST - Scan File](/1.9.1/opswat-filescan/ref#scan-file-api-scan-file-post)
...
Search for reports. Finds reports and uploaded files by various tokens. Use [GET - Search Report](/1.9.1/opswat-filescan/ref#search-report-api-reports-search-get) endpoint.
