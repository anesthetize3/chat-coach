...
{% /cell %}
{% cell %}
OPSWAT Filescan can be installed on a hardened Linux system that complies with the Level 1 profile of the[ CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
POC Guide: [https://docs.opswat.com/filescan/datasheet/poc-guide](https://docs.opswat.com/filescan/datasheet/poc-guide)
{% /cell %}
{% /row %}
{% /table %}
