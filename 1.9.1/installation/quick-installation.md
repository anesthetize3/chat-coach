...
{% callout type="warning" title="Warning" %}
Please use the **password** that you received from your OPSWAT Representative! Please adjust the x.y.z **version numbers** to match the downloaded filename!
{% /callout %}
...
Navigate to *Admin panel \> Settings \> License Management* tab, then click on *Activate All,* then **enter your license key**!
