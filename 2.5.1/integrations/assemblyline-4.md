...
{% inline-image url="asset:7yzllc3diapf" /%}
...
A summary report of the scan can be found under MetaDefender Sandbox result (heuristic):{% inline-image url="asset:8p3il6v7b1sj" /%}

Indicators are added in a subsections for heuristics:{% inline-image url="asset:knav6zqpvkr6" /%}
