...
You can find the API reference guide: auto$. For the following examples we used [Postman](https://www.postman.com/) which is an API platform for building and using APIs.
