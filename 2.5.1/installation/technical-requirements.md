...
- **Ubuntu Server 22.04** LTS ("Jammy Jellyfish") or **Ubuntu Server 24.04** LTS ("Noble") or **Red Hat Enterprise Linux 9.5** or **Rocky Linux 9.5**:
...
- The "minimized" version of Ubuntu Server is NOT suitable for **offline installations**, since it lacks some essential packages. Please select "Ubuntu Server" here: {% inline-image url="asset:kyelvjaq8y4z" /%}
