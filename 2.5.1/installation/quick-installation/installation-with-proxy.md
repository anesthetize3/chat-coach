...
If your proxy setup **breaks SSL connections** **(end-to-end encryption for HTTPS),** then the Sandbox installation will NOT succeed, and you should perform an [Offline Installation](../offline-installation.md) instead!
{% /callout %}
