...
Tags have colors based on their data type or severity context in which they were generated. The most common tag colors are: {% badge text="mediatype" /%} {% badge text="informational" type="primary" /%} {% badge text="suspicious" type="warning" /%} {% badge text="likely malicious or malicious" type="error" /%}
...
{% callout title="Info" %}
Note that [each supported file type](https://app.developerhub.io/metadefender-sandbox/2.1.0/datasheet/supported-file-types) has its own media type tag not listed here!
{% /callout %}
