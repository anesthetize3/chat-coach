...
{% inline-image url="asset:6yn1403f87s1" /%}
...
A summary report of the scan can be found under MetaDefender Sandbox result (heuristic):{% inline-image url="asset:olzywew0iph8" /%}

Indicators are added in a subsections for heuristics:{% inline-image url="asset:3thlgwp00d5y" /%}
