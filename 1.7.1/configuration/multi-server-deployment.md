...
Should the throughput requirement exceed 25K samples/day, then a typical single-server deployment is not sufficient anymore. For these cases, a multi-server deployment is necessary. The following diagram gives an idea of how such an architecture may look like:
