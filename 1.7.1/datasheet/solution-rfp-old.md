...
listed: true
description: 
index_title: Solution RFP
hidden: true
keywords: 
tags: 
---

The purpose of this page is to provide Question/Responses that may be used as part of a RFP process. It’s basically a more complete version of [OPSWAT\_FileScan\_Datasheet.pdf](https://static.opswat.com/uploads/files/OPSWAT_FileScan_Datasheet.pdf) going into more technical details, where needed.
...
More information available [here](https://docs.opswat.com/filescan/installation/technical-requirements#throughput-hardware-requirements).
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Side-by-side comparison including dynamic analysis available [here](https://docs.opswat.com/filescan/datasheet/supported-file-types).
...
More information available [here](https://docs.opswat.com/filescan/datasheet/supported-file-types).
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
Example: [Advanced search](https://www.filescan.io/advanced-search)

[**Threat Intelligence Cheat Sheet**](https://github.com/filescanio/fsCommunity/blob/master/Filescan_Cheat_Sheet.pdf)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
The deployment is fully automated and takes about 45-60 minutes depending on the internet connectivity. [See more in the POC/deployment guide.](https://docs.opswat.com/filescan/installation)
...
[On premise](https://docs.opswat.com/filescan/installation)
{% /cell %}
{% /row %}
{% /table %}
...
More information in the [OPSWAT Product documentation (User Guide)](https://docs.opswat.com/filescan/configuration/architecture-overview)
