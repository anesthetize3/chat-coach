...
Office Files with Foreign Language and Active Content: [report exampe](https://www.filescan.io/uploads/63d8695196add6d1cf4945a3/reports/e9ce37c2-2e3c-42b0-97b5-60915491b87b/overview), [search example](https://www.filescan.io/search-result?filetype=ms-office&verdict=malicious&tag=macros-on-open&unique_files=false&method=and&signal_groups=TXT000)
...
[Threat Feed](https://docs.opswat.com/filescan/opswat-filescan/ref#get-feed-api-feed-atom-get)

[Personal Threats Overview Page](https://www.filescan.io/threats-overview)

[API Documentation](https://docs.opswat.com/filescan/opswat-filescan/ref)
