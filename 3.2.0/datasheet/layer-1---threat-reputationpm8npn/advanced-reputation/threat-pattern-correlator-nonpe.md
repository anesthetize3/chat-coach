---
type: page
title: Threat Pattern Correlator - Support for Non-Executables
listed: true
description: 
index_title: Threat Pattern Correlator - Support for Non-Executables
hidden: false
keywords: 
tags: 
---
...
{% /cell %}
{% cell %}
CONFIRMED THREAT, HIGH RISK, LOW RISK, NO THREAT DETECTED, UNDETERMINED, TRUSTED
{% /cell %}
{% cell %}
CONFIRMED THREAT
{% /cell %}
