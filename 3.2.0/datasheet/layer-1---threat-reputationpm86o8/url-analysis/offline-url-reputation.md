---
type: page
title: URL Reputation Predictor Overview
listed: true
description: 
...
MetaDefender Aether \[formerly known as MetaDefender Sandbox\] on-premise / standalone integrates an Offline URL detector ML model.
...
Please find the Showcase Report [here.](../../web---phishing.md)

{% image url="../../../../assets/dc6909ffdcdc93b11723fd6244ab1fd54a253223.png" /%}
...
enableUrlReputationPredictor=true
```
{% /code %}
