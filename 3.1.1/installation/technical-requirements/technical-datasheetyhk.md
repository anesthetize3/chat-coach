...
- **Ubuntu Server 22.04, Ubuntu Server 24.04** or **Red Hat Enterprise Linux 9.5**
- 8 vCPUs (better: 16)
- 32 GB RAM
...
Due to the low resource requirements and cloud-native capability, MetaDefender Aether does not require nested VMs and can be deployed and operated with its proprietary emulation technology running directly on the host system.

More information available: [Throughput / Hardware Requirements](../technical-requirements.md#throughput--hardware-requirements)
...
{% /cell %}
{% cell %}
Side-by-side comparison including dynamic analysis available: [Supported File Types](../../datasheet/layer-1---threat-reputationpm86o8/supported-file-types.md).
...
More information available: [Supported File Types](../../datasheet/layer-1---threat-reputationpm86o8/supported-file-types.md).
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
Office files like Excel or Word documents are actually a type of compressed archive. Because of how they are built, there's a size limit on the sandbox side: no single file inside them can be larger than 2 GB. This is a technical restriction that cannot be changed.
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
The sandbox engine is also available as part of an integration with MetaDefender Core. More details: [MetaDefender Core Adaptive Sandbox Engine Features](../../integrations/md-core-engine.md)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
Example: [Advanced Search / Examples](../../datasheet/layer-1---threat-reputationpm8npn/advanced-search.md#examples)
...
Note: the solution may be installed and operated in an air-gapped environment. See [Offline Installation](../offline-installation.md)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
POC Guide: [API Workflow Guide](../../integrations/api-workflow-guide.md)
{% /cell %}
{% /row %}
{% /table %}
