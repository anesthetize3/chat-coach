...
- **JPHP Support**: Enhanced malware detection with the ability to parse and decompile JPHP files, expanding the range of supported file types and languages. [Supported packers for unpacking](../../datasheet/layer-1---threat-reputationpm86o8/executable-analysis/supported-packers-for-unpacking.md)
