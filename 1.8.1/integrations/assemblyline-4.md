...
{% code %}
```yaml {% title="Service manifest for 4.4.1.dev1" %}
# Name of the service
...
If you use the yml file from github, please change the $SERVICE\_TAG vaiable everywhere to the actual docker tag. (Now it's 4.4.1.dev1)
{% /callout %}
