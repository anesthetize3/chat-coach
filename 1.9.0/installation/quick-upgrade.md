...
**Step #5 - Move the OPSWAT\_Filescan\_\*.zip archive into the current folder (fsBootstrap)**
...
If you used the default installation location, then you can create and copy the `license.yml` file like this:
