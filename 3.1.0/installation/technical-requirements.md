...
- 256 GB **Free Disk Space** (SSD)\*: Sandbox requires 32 GB on the first installation (subsequent upgrades will potentially consume more disk space). More information for **multi-partition layouts**: [Low disk space](../troubleshooting/low-disk-space.md)
