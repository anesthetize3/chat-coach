...
listed: true
description: 
index_title: Online Installation
hidden: false
keywords: 
tags: 
---
...
{% callout type="warning" title="Warning" %}
If you have an active **AV engine or EDR agent** on the target system, please read this page before starting the installation: [Which paths should be excluded from AV engine/EDR agent scans on the sandbox server?](../faq/which-paths-should-be-excluded-from-av-engine-edr-agent-scans-on.md)
{% /callout %}

{% callout type="success" title="Pro Tip" %}
Before installing, please check out our [Proxy Usage](quick-installation/installation-with-proxy.md) or [Air-gapped Systems](offline-installation/notes-for-air-gapped-environments.md) pages if these requirements apply to you!
{% /callout %}
...
### Red Hat 9.x or Rocky Linux 9.x
...
Download the release archive from [https://my.opswat.com/portal/products](https://my.opswat.com/portal/products)  and save it to a convenient location, e.g. your home folder.
...
Please see the [Air-gapped Systems](offline-installation/notes-for-air-gapped-environments.md) subpage.
