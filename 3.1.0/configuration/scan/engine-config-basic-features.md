...
runFileDownloaderTimeoutMs=60000
...
checkCertificateRevocationMode=AUTO
...
{% row %}
{% cell %}
checkCertificateRevocationMode
{% /cell %}
{% cell %}
AUTO
{% /cell %}
{% cell %}
ON - enabled OFF - disabled AUTO - will be set based on other configurations
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
runFileVisualizerTimeoutMs=10000
```
{% /code %}
