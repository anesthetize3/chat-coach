...
**API Workflow Guide for MetaDefender Aether** (previously known as MetaDefender Sandbox)

**1. Log in to your instance using the provided email address and initial password (the Aether API key should be also be provided, and it can be regenerated any time)**

{% callout title="Best practices" %}
If you deployed your instance on-premise, then please check that the **MetaDefender Cloud Reputation API** [MetaDefender Cloud Reputation Service](reputation-api-integration.md) is configured correctly on your instance!
...
More information about Sandbox verdicts: [Report Verdict](../datasheet/layer-1---threat-reputationpm8/verdict.md)
  ...
  "reports": {
    "ab6647f6-132a-4a6b-ad82-dfe01daee4a8": {
      ...
      "finalVerdict": {
        ...
        "threatLevel": 0.1,
        "confidence": 1,
        "verdictLabel":	"no_threat_detected"
      },
      "file": {
        "name": "fix-plasma.sh",
