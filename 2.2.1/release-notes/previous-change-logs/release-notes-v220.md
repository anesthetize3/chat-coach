...
- **Zero-Day Office Document Support**: We now support the analysis of broken Office documents, including those used in zero-day attacks. This helps detect previously evasive threats targeting Office file vulnerabilities. [Showcase Reports](../../datasheet/showcase-reports.md)
...
- **Concatenated Archives Detection**: MetaDefender Sandbox can now analyze concatenated archives, a common bypass technique used by malware authors to evade detection. This improves our ability to detect malware hidden in complex archive structures. [Showcase Reports](../../datasheet/showcase-reports.md)
...
- **Mitigation for Bloated Executables**: A new mitigation feature identifies intentionally bloated executables that attempt to bypass sandbox environments. This enhances the platform's ability to analyze suspicious files that may try to evade detection. [Showcase Reports](../../datasheet/showcase-reports.md)
...
- **Adaptive Threat Indicators**: Threat indicators are now context-aware, allowing for more accurate identification of threats and a reduction in false positives. [Adaptive Threat Context](../../datasheet/adaptive-threat-context.md)
...
- **WebDAV Communications Identification**: MetaDefender can now identify WebDAV communications, improving the detection of network-based attacks that use this protocol. [Sandbox Tags](../../datasheet/sandbox-tags.md)
- **Enhanced Phishing Detection**: We’ve added 38 new brands to our phishing detection capabilities, significantly improving the platform’s overall phishing detection accuracy. Additionally, phishing URL rendering now bypasses SSL certification for missing sites. [What brands does the sandbox detect?](../../datasheet/url-analysis/detected-brands.md)
...
- **Exported Reports (My Downloads)**: Users can now view exported reports directly on the "My Downloads" page, streamlining access to previously generated reports. [Output Report Formats](../../datasheet/export-formats.md)
- **Settings for HTML \& PDF Report Generator**: Added customizable settings for generating HTML \& PDF reports, offering greater flexibility in report formats and content. [Output Report Formats](../../datasheet/export-formats.md)
...
- **Similarity Search for All File Types**: Similarity search now supports all file types, not just PE files, expanding its ability to detect malicious files based on structural similarities. [Similarity Search - Support for Non-Executables](../../datasheet/advanced-reputation/similarity-search-lightweight.md)
...
- **WebThreat URL Threat Detection Model:** Enabling advanced phishing detection through network data analysis for enhanced URL threat protection. [Web Threat Detection Overview](../../datasheet/url-analysis/webthreat.md)
