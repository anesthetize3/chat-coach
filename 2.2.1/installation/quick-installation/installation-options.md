...
{% /cell %}
{% cell %}
If set to true, the installer will clone GitHub repositories containing the latest YARA rules provided by the Malware Analysis community (these repositories are not controlled by OPSWAT). More details at [YARA Rules](../../configuration/yara-rules.md).
{% /cell %}
{% /row %}
{% row %}
{% cell %}
