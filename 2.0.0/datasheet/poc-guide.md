...
**POC Guide for MetaDefender Sandbox** (previously known as OPSWAT Filescan Sandbox)
...
If you deployed your POC instance on-premise, then please check that the **MetaDefender Cloud Reputation API** [MetaDefender Cloud Reputation Service](../integrations/reputation-api-integration.md) is configured correctly on your instance before continuing this POC guide!
...
**a.** Calculate the SHA-256 hash of your sample and call the sandbox Reputation API: [https://docs.opswat.com/filescan/opswat-filescan/ref#get-reputation-api-reputation-get](https://docs.opswat.com/filescan/opswat-filescan/ref#get-reputation-api-reputation-get)
