...
- **Ubuntu Server 22.04**
- 8 vCPUs (better: 16)
- 16 GB RAM (better: 32 GB)
- 100 GB SSD (better: 500 GB)
...
{% /cell %}
{% cell %}
The sandbox engine is also available as part of an integration with MD Core. More details: [MD Core Sandbox Engine Features](../integrations/md-core-engine.md)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
Note: the solution may be installed and operated in an air-gapped environment. See \_\_[Offline Installation](../installation/offline-installation.md)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
POC Guide: [POC Guide](poc-guide.md)
{% /cell %}
{% /row %}
{% /table %}
