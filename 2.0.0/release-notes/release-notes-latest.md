...
- Introduced a Machine Learning model to identify suspicious URLs even in offline mode (this experimental feature is only enabled by default in offline mode): [Offline URL Reputation Overview](../datasheet/offline-url-detector.md)
