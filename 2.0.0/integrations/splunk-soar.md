...
MetaDefender Sandbox integration in Splunkbase marketplace available [here](https://splunkbase.splunk.com/app/6942).
...
{% image url="https://uploads.developerhub.io/prod/XX2D/omolc0j1o9m81m4hftsl1cuk5l09t0hghjxnxuy1c0tdesl4dhvx0hor5htmzry0.png" /%}

#### Install from Splunkbase

Download MetaDefender Sandbox from Splunkbase: [https://splunkbase.splunk.com/app/6942](https://splunkbase.splunk.com/app/6942)

{% image url="https://uploads.developerhub.io/prod/XX2D/m56tnxonzwnafddzegaorh3zheov1sk6btf5apyj7inmw66vardibamjtj1bor32.png" /%}
...
{% image url="https://uploads.developerhub.io/prod/XX2D/rh4g7owc580wf0fd0t5q81q5aba07nyihpstfqzurmi0hrgeef2281w823jcucik.png" /%}

## Configuration

After installed, you can find MetaDefender Sandbox app under the "Unconfigured Apps" list:

{% image url="https://uploads.developerhub.io/prod/XX2D/zdmghc9hzr8ub2jxd6x9xegabx2nvktaldexspq9djsy47m9x3ps87isvrutp2s1.png" /%}

Under 'CONFIGURE NEW ASSET' fill the required fileds.

Under *Asset Info* tab, please fill the asset name and description:

{% image url="https://uploads.developerhub.io/prod/XX2D/60vfstu1t9siktuhqu75xkjhxoh7u4row71rh0t5npdcsoobn5dixb4lqcl5cku3.png" /%}

After this, configure the connection under *Asset Settings* tab:

{% image url="https://uploads.developerhub.io/prod/XX2D/yxvu45j95tooacx7iaae7orgs2j0fjqv4sr7khg4b0bs1ieh4db6qv7fjndm5bzd.png" /%}
...
{% image url="https://uploads.developerhub.io/prod/XX2D/4ziie8azlzqvcvu60rliugow8ax8byesvs70uyqjw4dc68113h4prviaeoqiiaco.png" /%}

## Available actions

### detonate url

Scan URL resource with Sandbox [POST - Scan URL](/2.0.0/metadefender-sandbox-api-reference-v1/ref#scan-file-api-scan-url-post)
...
Scan file resource with Sandbox [POST - Scan File](/2.0.0/metadefender-sandbox-api-reference-v1/ref#scan-file-api-scan-file-post)
...
Search for reports. Finds reports and uploaded files by various tokens. It uses [GET - Search Report](/2.0.0/metadefender-sandbox-api-reference-v1/ref#search-report-api-reports-search-get) endpoint and the 'query' field.
...
Get the reputation for one given hash (returns with the last 10 sandbox reports). It uses [GET - Get Reputation](/2.0.0/metadefender-sandbox-api-reference-v1/ref#get-reputation-api-backend-reputation-get) endpoint.
...
Get the reputation for one given hash (returns with the last 10 sandbox reports). It uses [GET - Get Reputation Ioc](/2.0.0/metadefender-sandbox-api-reference-v1/ref#get-reputation-ioc-api-reputation-ioc-type-get) endpoint.
