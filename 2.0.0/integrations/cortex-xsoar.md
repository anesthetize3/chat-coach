...
Search for reports. Finds reports and uploaded files by various tokens. Use [GET - Search Report](/2.0.0/metadefender-sandbox-api-reference-v1/ref#search-report-api-reports-search-get) endpoint.
