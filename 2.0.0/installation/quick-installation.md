...
**Step #4 - (Optional) Edit install.cfg to specify a custom user name and installation path**
...
**Step #6 - Access the Sandbox web server ([https://localhost:443](https://localhost:443)) and setup the initial Admin user**
