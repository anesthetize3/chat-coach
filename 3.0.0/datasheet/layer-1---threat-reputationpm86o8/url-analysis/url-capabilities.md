---
type: page
title: What URL analysis capabilities are in MetaDefender Aether?
listed: true
description: 
...
**MetaDefender Aether** (previously known as MetaDefender Sandbox) offers a variety of features around URL analysis. Here are the highlights:
