...
{% /cell %}
{% cell %}
This is internal secret key used for communication between components of MetaDefender Sandbox. The value is masked for security reasons. The default value is set by the Sandbox installer. The default value should not be changed.
{% /cell %}
{% /row %}
{% /table %}
