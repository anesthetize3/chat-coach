...
The *ENGINE\_DATABASE\_CHECK\_\_\_FOR\_\_\_UPDATES setting must be enabled in order for the automatic update feature to run. If it is disabled, the automatic updates will not run regardless of the state of the other settings.*
{% /callout %}
