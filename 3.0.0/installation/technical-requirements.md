...
- 256 GB **Free Disc Space** (SSD)\*: Sandbox requires 32 GB on the first installation (subsequent upgrades will potentially consume more disk space). More information for multi-partition layouts: [Low disk space](../troubleshooting/low-disk-space.md)
...
- The "minimized" version of Ubuntu Server is NOT suitable for **offline installations**, since it lacks some essential packages. Please select "Ubuntu Server" here: {% inline-image url="asset:5tep1ojt2j80" /%}
