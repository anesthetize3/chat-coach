...
- **Ubuntu Server 22.04** LTS ("Jammy Jellyfish"):
  - Support for **Ubuntu Server 20.04** LTS ("Focal Fossa") will be deprecated with the upcoming 2.0.0 Release
  - Please download the Ubuntu ISO image from: [https://releases.ubuntu.com/focal/](https://releases.ubuntu.com/focal/) or [https://releases.ubuntu.com/jammy/](https://releases.ubuntu.com/jammy/)
...
- 32 GB RAM
- 100 GB **Free Disc Space** (SSD): Filescan requires 32 GB on the first installation (subsequent upgrades will potentially consume more disk space)
