...
listed: false
description: 
index_title: Similarity Search (Backup)
hidden: true
keywords: 
tags: 
---
...
{% row %}
{% cell %}
Metadata is feature split
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Indicates if APK is a feature split
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata is split required
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Indicates if split is required
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata isolated splits
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Indicates if splits are isolated
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata min sdk version
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Minimum SDK version required by the APK
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata target sdk version
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Target SDK version required by the APK
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata gles version major
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Major version of GLES required
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata gles version minor
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Minor version of GLES required
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata gles version required
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Required GLES version
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata any density
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Supports any screen density
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% row %}
{% cell %}
Metadata normal screens
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Supports normal screens
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata large screens
{% /cell %}
{% cell %}
String
{% /cell %}
...
{% /cell %}
{% cell %}
Label or name of the APK
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata install location
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Installation location of the APK
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Metadata uses permissions name
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Permissions used by the APK
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Main activity of the APK
{% /cell %}
{% /row %}
{% row %}
{% cell %}
APK receivers intent filters name
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Intent filters of APK receivers
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% row %}
{% cell %}
Overview fake clock time
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Overview of fake clock time in emulation metadata
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Overview of pass count in emulation metadata
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Overview total code lines
{% /cell %}
{% cell %}
Number
{% /cell %}
{% cell %}
Overview of total code lines in emulation metadata
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Overview total functions
{% /cell %}
{% cell %}
Number
{% /cell %}
{% cell %}
Overview of total functions in emulation metadata
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Additional information command
{% /cell %}
{% cell %}
String
{% /cell %}
...
{% row %}
{% cell %}
Additional information entrance
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Additional information about the entrance
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Additional information about the URI
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Index of the icon in the header
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Link info location info drive serial number
{% /cell %}
{% cell %}
Number
{% /cell %}
{% cell %}
Serial number of the drive in the link info location
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Link info location info r drive type
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Type of the R drive in the link info location
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% row %}
{% cell %}
Segment header entrypoint
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Entry point of the segment header
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Segment header filerva
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
File RVA of the segment header
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% row %}
{% cell %}
Total segmentheaders
{% /cell %}
{% cell %}
Number
{% /cell %}
{% cell %}
Total segment headers
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Modified timestamps of the file
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
File RVA of segments
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Segments sizeofrawdata
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Size of raw data in segments
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% row %}
{% cell %}
Strings in binary image OCR
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Strings detected in binary image OCR
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Strings in binary internal
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Internal strings in the binary
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Strings in binary input file
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Strings found in the input file
{% /cell %}
{% /row %}
{% row %}
{% cell %}
Strings in binary VBA emulation
{% /cell %}
{% cell %}
String
{% /cell %}
{% cell %}
Strings related to VBA emulation
{% /cell %}
{% /row %}
{% /table %}
{% /tab %}
...
{% /cell %}
{% cell %}
Strings referencing triggered consumer IDs
{% /cell %}
{% /row %}
{% /table %}
{% /tab %}
