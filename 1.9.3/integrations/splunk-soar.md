...
Scan URL resource with Filescan POST - Scan URL
...
Scan file resource with Filescan POST - Scan File
...
Search for reports. Finds reports and uploaded files by various tokens. It uses auto$ endpoint and the 'query' field.
