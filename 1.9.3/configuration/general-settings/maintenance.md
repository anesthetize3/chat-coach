...
These configurations in MetaDefender Sanbox is to control functionalities related to blocking scanning and search features within the sandbox,  and used for maintenance purposes.
