---
type: page
title: Sandbox Engine Options
listed: true
description: 
index_title: Sandbox Engine Options
hidden: true
keywords: 
tags: 
---
...
{% /cell %}
{% cell %}
If enabled, OSINT lookups (currently: OPSWAT Reputation API, VirusTotal API and ClamAV) will be performed in general (it is a global flag).
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
If enabled, OSINT lookups will be performed on extracted files. If it is desired to reduce the total number of queries, this option can be disabled. However, if a high-volume API key is available, it should be enabled for improved detection.
{% /cell %}
{% /row %}
{% row %}
{% cell %}
