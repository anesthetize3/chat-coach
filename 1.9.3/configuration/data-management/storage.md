...
{% /cell %}
{% cell %}
This setting specifies the default file manager used for storing and handling files. In this case, it's set to "s3," indicating that the system uses Amazon Simple Storage Service (S3) for file storage.
{% /cell %}
{% /row %}
{% row %}
{% cell %}
