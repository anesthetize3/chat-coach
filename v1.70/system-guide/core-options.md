...
{% /cell %}
{% cell %}
If enabled, OSINT lookups (currently: VirusTotal andClamAV) will be performed in general (it is a global flag).
{% /cell %}
{% /row %}
{% row %}
{% cell %}
unOSINTLookupsOnExtractedFiles
{% /cell %}
{% cell %}
false
{% /cell %}
