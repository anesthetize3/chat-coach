---
type: page
title: MD Cloud Reputation API
listed: true
description: 
index_title: MD Cloud Reputation API
hidden: false
keywords: 
tags: 
---

MetaDefender Sandbox on-premise / standalone integrates with the MetaDefender Cloud Reputation API:
...
**Step #3 - Set the MD Cloud API options**
...
**Step #3 - Scan a file and verify if the OPSWAT Reputation API results are displayed in OSINT Lookup section**
