---
type: page
title: Do you use sandbox technology?
listed: true
description: 
index_title: Do you use sandbox technology?
hidden: false
keywords: 
tags: 
---
...
**MetaDefender Sandbox** is a best-in-class emulation sandbox with a proven track record of detecting highly evasive stage one malware. See showcase reports here: [https://docs.opswat.com/filescan/datasheet/showcase-reports](https://docs.opswat.com/filescan/datasheet/showcase-reports)
