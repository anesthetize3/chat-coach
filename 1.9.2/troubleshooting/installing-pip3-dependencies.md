---
type: page
title: Failed to install pip3 dependencies (v1.7.3 or older)
listed: true
description: 
index_title: Failed to install pip3 dependencies (v1.7.3 or older)
hidden: true
keywords: 
tags: 
---
...
This page only applies for v1.7.3 or older. Starting from v1.7.4, all Python dependencies are bundled into the release artifact.
{% /callout %}
