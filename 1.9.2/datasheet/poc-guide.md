...
If you deployed your POC instance on-premise, then please check that the **MetaDefender Cloud Reputation API** [MD Cloud Reputation API](../integrations/reputation-api-integration.md) is configured correctly on your instance before continuing this POC guide!
