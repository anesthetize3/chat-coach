...
To install MetaDefender Sandbox on an offline system without an Internet connection, it is necessary to **prepare the offline installation assets** on an **online computer** or virtual machine running **Ubuntu 22.04 or Ubuntu 24.04**.

{% callout title="Info" %}
Please note that offline installation is **NOT** supported yet on **Red Hat Enterprise Linux 9**.
{% /callout %}
...
An **online system** running Ubuntu 22.04 or Ubuntu 24.04 is required for Phase 1.
...
Please prepare an **offline system** running Ubuntu 22.04 or Ubuntu 24.04.
