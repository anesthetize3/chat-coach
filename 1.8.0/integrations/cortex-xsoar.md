...
Search for reports. Finds reports and uploaded files by various tokens. Use [GET - Search Report](/1.8.0/opswat-filescan/ref#search-report-api-reports-search-get) endpoint.
