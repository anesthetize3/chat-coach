...
Download OPSWAT FIlescan from Splunkbase: [https://splunkbase.splunk.com/app/6942](https://splunkbase.splunk.com/app/6942) and in Splunk under Apps select "Insall App":
...
Scan URL resource with Filescan [POST - Scan URL](/1.8.0/opswat-filescan/ref#scan-file-api-scan-url-post)
...
Scan file resource with Filescan [POST - Scan File](/1.8.0/opswat-filescan/ref#scan-file-api-scan-file-post)
...
Search for reports. Finds reports and uploaded files by various tokens. It uses [OPSWAT Filescan API Reference v1](/1.8.0/opswat-filescan/ref#search-report-api-reports-search-get) endpoint and the 'query' field.
...
Get the reputation for one given hash (returns with the last 10 Filescan reports). It uses [GET - Get Reputation](/1.8.0/opswat-filescan/ref#get-reputation-api-reputation-get) endpoint.
