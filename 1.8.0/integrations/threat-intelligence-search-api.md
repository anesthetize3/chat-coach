...
- Create an MD Cloud API key at [metadefender.opswat.com](https://metadefender.opswat.com/) (Default limit: 25)
- Download the [Postman collection ](https://github.com/filescanio/fsCommunity/tree/master/postman_collections)and import it into [Postman](https://www.postman.com/downloads/)
- Reach out to your OPSWAT Representative or email stephanie.luangraj@opswat.com to upgrade limits

To find out more visit [here](https://docs.opswat.com/mdcloud/threat-intelligence) or view the [MetaDefender Cloud Store ](https://metadefender.opswat.com/store)for purchasing options.
