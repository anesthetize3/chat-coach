...
{% row %}
{% cell %}
runVBADecoderForEmbeddedScriptFilesMinimumByteSize
{% /cell %}
{% cell %}
256 byte
{% /cell %}
{% cell %}
Limit: minimum file size for script file emulation
{% /cell %}
{% /row %}
{% row %}
{% cell %}
...
{% /cell %}
{% cell %}
Switch to enable / disable PE emulation
{% /cell %}
{% /row %}
{% row %}
{% cell %}
portExEmuExecutionTimeout
{% /cell %}
{% cell %}
90 seconds
{% /cell %}
...
{% row %}
{% cell %}
portExEmuPerformDeepStaticAnalysisForExtractedFiles
{% /cell %}
{% cell %}
true
{% /cell %}
...
{% row %}
{% cell %}
portExEmuPerformDeepStaticAnalysisForExtractedFilesMax
{% /cell %}
{% cell %}
10
{% /cell %}
...
{% row %}
{% cell %}
portExEmuPerformDeepStaticAnalysisForExtractedFilesMaxSizeInKb
{% /cell %}
{% cell %}
5 MB
{% /cell %}
{% cell %}
Limit: max file size for static analysis of files detected during PE emulation
{% /cell %}
{% /row %}
{% /table %}
