...
To install MetaDefender Sandbox on an offline system without an Internet connection, it is necessary to **prepare the offline installation assets** on an **online computer** or virtual machine running **Ubuntu 22.04 or Ubuntu 24.04 or** **Red Hat Enterprise Linux 9.5**.
...
An **online system** running Ubuntu 22.04 or Ubuntu 24.04 or Red Hat Enterprise Linux 9.5 is required for Phase 1.
...
Please prepare an **offline system** running Ubuntu 22.04 or Ubuntu 24.04 or Red Hat Enterprise Linux 9.5.
