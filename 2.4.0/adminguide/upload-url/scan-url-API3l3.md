...
You can find the API reference guide: [API Reference](/2.4.0/metadefender-sandbox-api-reference/ref). For the following examples we used [Postman](https://www.postman.com/) which is an API platform for building and using APIs.
...
### Step 2 - Paste the Filescan URL

Paste the Filescan URL to the "Enter request URL" field: [https://www.filescan.io/api/scan/url](https://www.filescan.io/api/scan/url)
