---
type: page
title: What URL analysis capabilities are in Filescan?
listed: true
description: 
index_title: What URL analysis capabilities are in Filescan?
hidden: true
keywords: 
tags: 
---

OPSWAT Filescan (Sandbox) offers a variety of features around URL analysis. Here are the highlights:
...
- Currently detects 260+ major brands
- Additional integrations with Google Safebrowsing

**Do you have an example API request/response?**

1. Submit a file using the `/api/scan/url` endpoint (Reference: https://www.filescan.io/api/docs#/scan/scan\_file\_api\_scan\_url\_post) and obtain a flow\_id
...
{% image url="https://uploads.developerhub.io/prod/XX2D/qhk8bhptslfz8bszsxvzopqmc656ff3z90v5wj9y0nl8wh77smkwr49gmwdnnons.png" /%}
