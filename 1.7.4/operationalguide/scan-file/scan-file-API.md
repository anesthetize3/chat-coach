...
You can find the API reference guide: [OPSWAT Filescan API Reference v1](/1.7.4/opswat-filescan/ref). For the following examples we used [Postman](https://www.postman.com/) which is an API platform for building and using APIs.
