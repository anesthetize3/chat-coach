...
The purpose of this page is to provide Question/Responses that may be used as part of a RFP process. It’s basically a more complete version of [OPSWAT\_FileScan\_Datasheet.pdf](https://static.opswat.com/uploads/files/OPSWAT_FileScan_Datasheet_v3.pdf) going into more technical details, where needed.
...
{% /cell %}
{% cell %}
Filescan is also available as part of an integration with MD Core. More details: [MD Core Engine Features](../integrations/md-core-engine.md)
{% /cell %}
{% /row %}
{% row %}
{% cell %}
